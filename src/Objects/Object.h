...
typedef struct ac_object{
    ...
    vect2d (*collideEdge)(vect2d pos,vect2d dir,struct ac_object *self,ac_state** current,ac_state** next,SDL_Renderer* renderer,SDL_Window* window,char* ac_flags,SDL_Event* evt);
}ac_object;
#endif